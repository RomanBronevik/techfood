<template>
  <div>
    ...
    <section class="fdb-block fp-active" data-block-type="features" data-id="2">
      <div class="container">
        <div class="row justify-content-center pb-5">
          <div class="col-12 text-center" style="z-index: 10000;"><h1 id="features">Функционал кулинарной соц. сети</h1></div>
        </div>
